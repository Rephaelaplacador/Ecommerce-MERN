...
const GiftCouponCard = () => {
	...
	return (
		...
		>
            ...
            p-2.5 text-sm text-white placeholder-gray-400 focus:border-gray-500 
            focus:ring-gray-500'
				...
				<motion.button
					type='button'
					className='flex w-full items-center justify-center rounded-lg bg-gray-950 px-5 py-2.5 text-sm font-medium text-white hover:bg-gray-950 focus:outline-none focus:ring-4 focus:ring-gray-300'
